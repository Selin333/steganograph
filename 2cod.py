...
doc = docx.Document('C:\\Users\\Gdl\\Desktop\\ВКБ\\Сафарьян\\2\\2\\10.docx')
...
text = "Без хлопот и труда растет не кукуруза, а лебеда."
...
for i in range(len(doc.paragraphs)):
    ...
    for id_rans in range(LenParagraphs[i]):
            run = doc.paragraphs[i].add_run(OpenText[id_char])
...
doc.save('C:\\Users\\Gdl\\Desktop\\ВКБ\\Сафарьян\\2\\2\\scrito.docx')
